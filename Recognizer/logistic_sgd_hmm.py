...
def load_data(dataset):
    ...
    with open('base_fbank_d.pkl', 'rb') as f:
        base = dill.load(f)

    with open('base_fbank_teste_d.pkl', 'rb') as f:
        base_teste = dill.load(f)
    #dados_x = dados[:,0:256]
    #dados_y = dados[:,256]
    ...
    lista = numpy.arange(0,18383) #29028
    ...
    i = 6000
    train_setx = dados[0:18300,:]
    train_sety = labels[0:18300] #29028

    valid_setx = base_teste[0][0:11500,:]
    valid_sety = numpy.append([],base_teste[1][:])[0:11500] #4750
